defmodule ExMon.Game.Actions.Attack do
  ...
  def attack_opponent(opponent, move) do
    ...
    |> Game.fetch_player()
    |> Map.get(:life)
    |> calculate_remaining_life(damage)
  ...
  defp calculate_remaining_life(life, damage) when life - damage < 0, do: 0
  defp calculate_remaining_life(life, damage), do: life - damage
